...
```
2019/05/20 01:46:16 INFO  [ItemQuery.java:60] : Query item 1: { Item: {release_uts=1008892800, country=United States, year=2001, detail_info={release_date=2001-12-21T00:00:00Z, directors=[Ron Howard], roles=[John Nash, Alicia Nash], rating=6.5, language=English}, title=A Beautiful Mind} }
2019/05/20 01:46:16 INFO  [ItemQuery.java:60] : Query item 2: { Item: {release_uts=994896000, year=2001, detail_info={release_date=2001-07-12T00:00:00Z, directors=[Stephen Chow, Lee Lik-Chi], roles=[A-Hsing, May], rating=5.5, language=Cantonese}, title=Shaolin Soccer} }
2019/05/20 01:46:16 INFO  [ItemQuery.java:60] : Query item 3: { Item: {release_uts=995587200, year=2001, detail_info={release_date=2001-07-20T00:00:00Z, directors=[Hayao Miyazaki], roles=[Sen, Haku, No-Face], rating=7, language=Japanese, box_office=$331.4 million}, title=Spirited Away} }
2019/05/20 01:46:16 INFO  [ItemQuery.java:60] : Query item 4: { Item: {release_uts=1002931200, country=United States, year=2001, detail_info={release_date=2001-10-13T00:00:00Z, directors=[Robert "Rob" Cohen], roles=[Brian O'Conner, Dominic "Dom" Toretto, Leticia "Letty" Ortiz, Mia Toretto], rating=6.5, language=English}, title=The Fast And The Furious} }
2019/05/20 01:46:16 INFO  [ItemQuery.java:62] : Query 4 items with year=[2001] succeeded.
```

#### `queryItemsByYearAndMultiDirector(table, 2001)`:

```
2019/05/20 01:46:16 INFO  [ItemQuery.java:89] : Query item 1: { Item: {release_uts=994896000, year=2001, detail_info={release_date=2001-07-12T00:00:00Z, directors=[Stephen Chow, Lee Lik-Chi], roles=[A-Hsing, May], rating=5.5, language=Cantonese}, title=Shaolin Soccer} }
2019/05/20 01:46:16 INFO  [ItemQuery.java:91] : Query 1 items with year=[2001] and multiple directors succeeded.
```
...
```
2019/05/20 01:46:16 INFO  [ItemQuery.java:127] : Query item 1: { Item: {detail_info={roles=[Sen], rating=7, box_office=$331.4 million}, year=2001, title=Spirited Away} }
2019/05/20 01:46:16 INFO  [ItemQuery.java:127] : Query item 2: { Item: {detail_info={roles=[Brian O'Conner], rating=6.5}, year=2001, title=The Fast And The Furious} }
2019/05/20 01:46:16 INFO  [ItemQuery.java:129] : Query 2 items with year=2001 and titles S-Z succeeded
```
